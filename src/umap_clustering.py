...
def plot_clusters_vs_groups(x_umap, labels_dictionary, group_column, save_path, title_prefix):
    n = len(labels_dictionary)
    n_cols = 2
    n_rows = n

    margin = 5  # Fixed margin
...
def main(df_masked, df_meta, save_path, title_umap, title_cluster):
    ...
    plot_clusters_vs_groups(x_umap, labels_dict, labeling_umap['group'], save_path, title_cluster)
